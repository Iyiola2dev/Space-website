...
const Home = () => {
  return (
    <div className=" bg-mobile  bg-cover bg-center h-screen min-h-screen md:bg-tablet mt-[-6rem] flex flex-col items-center justify-center  mx-auto  text-center lg:text-justify lg:items-start  md:gap-20  lg:bg-desktop lg:flex-row lg:space-x-32 lg:pt-24 xl:space-x-72 xl:pt-0">
      ...
      <div className=" flex flex-col items-center justify-center lg:items-start  text-center lg:text-left md:w-[450px] md:h-[334px]  pt-5 md:pt-10 gap-3 md:gap-[4.5rem] lg:gap-[2rem] lg:mt-[10rem] xl:w-[450px] xl:h-[450px] ">
        ...
        <h2 className="w-[327px] font-[400]  h-[100px] lg:px-4 md:w-[445px] text-[80px] md:text-[150px] leading-[100px] md:leading-[150px] text-[#FFFFFF]  font-bellefair ">
          SPACE
        </h2>
